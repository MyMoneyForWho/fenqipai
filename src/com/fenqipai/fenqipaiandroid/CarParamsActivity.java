...
/**
 * @Description:车辆配置参数界面
 * @author hunaixin
 * @date 2016年11月25日 上午11:07:48
 */
public class CarParamsActivity extends BaseActivity {
	
	@ViewInject(R.id.car_params_titlebar)
	private TitleBarView titlebar;
	
	@ViewInject(R.id.car_params_webview)
	...
	private void initView() {
		...
		titlebar.setTitleText(R.string.titlebar_car_params);
