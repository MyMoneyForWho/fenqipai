...
import com.fenqipai.fenqipaiandroid.view.wheelview.OnWheelChangedListener;
import com.fenqipai.fenqipaiandroid.view.wheelview.OnWheelScrollListener;
import com.fenqipai.fenqipaiandroid.view.wheelview.WheelView;
import com.fenqipai.fenqipaiandroid.view.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeDatePopwindow extends PopupWindow implements View.OnClickListener {
	...
	public ChangeDatePopwindow(final Context context) {
		...
		mDaydapter = new CalendarTextAdapter(context, arry_days, Integer.parseInt(currentDay) - 1, maxTextSize,
				minTextSize);
	 ...
	 * @param month
	 * @param year
	 * 西元年分除以400可整除，为闰年。 西元年分除以4可整除但除以100不可整除，为闰年。 西元年分除以4不可整除，为平年。
