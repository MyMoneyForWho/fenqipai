...
public class CycleViewPager extends FrameLayout implements OnPageChangeListener {
	...
	public void setData(List<View> views, List<String> carouselList, ImageCycleViewListener listener) {
		setData(views, carouselList, listener, 0);
	}
	...
	public void setData(List<View> views, List<String> carouselList, ImageCycleViewListener listener,
		...
		for (int i = 0; i < indicators.length; i++) {
			View view = LayoutInflater.from(mContext).inflate(R.layout.view_cycle_viewpager_indicator, null);
	...
	private void setIndicator(int selectedPosition) {
		for (int i = 0; i < indicators.length; i++) {
			indicators[i].setBackgroundResource(R.drawable.indicators_focus_off);
		}
		if (indicators.length > selectedPosition)
			indicators[selectedPosition].setBackgroundResource(R.drawable.indicators_focus_on);
	}
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(String notice, int postion, View imageView);
	}
}