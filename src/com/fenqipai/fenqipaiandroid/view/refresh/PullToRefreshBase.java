package com.fenqipai.fenqipaiandroid.view.refresh;

import com.fenqipai.fenqipaiandroid.view.refresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * isTouch 如果是触摸出发的刷新
	 */
	protected void startRefreshing(final boolean isTouch) {
		// 如果正在刷新
		if (isPullRefreshing()) {
			return;
		}
