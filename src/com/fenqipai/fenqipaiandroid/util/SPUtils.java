...
public class SPUtils {
	...
	public static void put(Context context, String key, Object object) {
		...
		SharedPreferences sp = context.getSharedPreferences(Contants.SHARD_PRE_NAME, Context.MODE_PRIVATE);
	 ...
	 * @param object
	 */
	public static void putPortrait(Context context, String key, Object object) {
		
		String portrait=object.toString();
		if (!TextUtils.isEmpty(portrait)) {
			if (!portrait.startsWith("http")) {
				portrait=URL.getURL( URL.FILE_UPLOAD)
						+	portrait;
			}
		}
		object=portrait;
